...
class PermanentEmployee extends Employee 
{
    ...
    public PermanentEmployee(String empId, String name, String department, double basicSalary, double bonus) 
    {
        ...
        super(empId, name, department, basicSalary);  // calls parent call constructor
...
class PayrollSystem 
{
    ...
    public void addPermanentEmployee() 
    {
        ...
        PermanentEmployee permanentemployee = new PermanentEmployee(empId, name, department, basicSalary, bonus);
    ...
    public void addContractualEmployee() 
    {
        ...
        ContractualEmployee contractualemployee =new ContractualEmployee(empId, name, department, hourlyRate, hoursWorked);
